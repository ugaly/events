...
export const DRINKS_I18N = {
  en: {
    ...
    comingTitle: 'Your order is coming',
    comingSubtitle: 'Please relax — our team is preparing your drinks now.',
    stageQueued: 'Queued',
    stageMixing: 'Mixing',
    stageServing: 'Serving to your table',
  ...
  sw: {
    ...
    comingTitle: 'Oda yako inakuja',
    comingSubtitle: 'Tafadhali tulia — timu yetu inaandaa vinywaji vyako sasa.',
    stageQueued: 'Imepokelewa',
    stageMixing: 'Inaandaliwa',
    stageServing: 'Inaletwa mezani',
